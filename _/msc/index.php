...
<header> <h1> LightBook </h1> <h2>Projeto: MUSIC</h2> <br/> <?php include_once'mn.php' ?> </header>
<section>

    <table class="table table-bordered table-inverse table-striped text-md-left">
        <thead>
        <tr>
            <th> Nome </th>
            <th> - </th>
...
while($arquivo = $diretorio -> read()){
    if ($arquivo != '.' && $arquivo != '..') {
        ...
        <tr>
            <td class='p-y-0'> $arquivo </td>
            <td class='p-y-0'> <audio src='$path$arquivo' controls preload='none'><p>Seu nevegador não suporta o elemento audio.</p></audio> </td>
        </tr>
