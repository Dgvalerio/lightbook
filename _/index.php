...
<section>
    ...
    <div class="card b-cl-12 m-x-1">
        ...
        <div class="card-block">
            ...
            <p class="card-text"> <b> - </b>: Em mau estado. </p> <br/>
        </div>
    </div>

    <div class="card b-cl-12 m-x-1">
        <div class="card-block">
            <h4 class="card-title"><span class="glyphicon glyphicon-tags"></span> Atalhos </h4>
            <p class="card-text"> <b> (+) </b>: Em bom estado. </p>
        </div>

        <div class="card-block">
            <a onclick="toLocal(3)" href="tlh/index.php" class="btn btn-primary">Vamos lá</a>
        </div>
    </div>
    ...
    <div class="card b-cl-12 m-x-1">
        ...
        <div class="card-block">
            <a onclick="toLocal(5)" href="imp/index.php" class="btn btn-primary">Vamos lá</a>
        </div>
    </div>
